...
export default function AdminTeamSettings(): React.JSX.Element {
  ...
  const saveMutation = useMutation<void, Error, TeamSettingsForm>({
    mutationFn: async (values: TeamSettingsForm): Promise<void> => {
  ...
  function handleChange(key: keyof TeamSettingsForm, value: string | number): void {
