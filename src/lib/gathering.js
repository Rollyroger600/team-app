 ...
 * @param {string} matchTime - "HH:mm" format
 * @param {number|null} travelMinutes - travel duration in minutes (null = home game)
 * @param {object} settings - { gathering_lead_time, travel_buffer_minutes }
 * @returns {string|null} - "HH:mm" format or null if matchTime is null
 */
export function calculateGatheringTime(matchTime, travelMinutes, settings) {
 ...
 */
export function formatGatheringDisplay(match, teamSettings) {
